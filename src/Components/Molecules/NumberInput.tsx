...
function NumberInput({ textinfo }: NumberInputType) {
    ...
    return (
        <CenterContainer>
            ...
            <Text text={textInfo} /> 
            <Input type="text" placeholder="숫자를 입력하세요" padding="5px" width="100%" changeSetNumber={setInputNumber} />
            <Button onClick={() => console.log("안녕")} size="small" text="이전 페이지" margin="10px" width="100%"/>
        </CenterContainer>
    )
}
